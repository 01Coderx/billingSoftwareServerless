  ...
  if (!invoice) {
    return (
      <div>
        ...
        <div className="mt-5 card p-8 text-rose-600">
    ...
    <div className="fade-in">
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_340px]">
        <section className="card overflow-hidden">
          ...
          <div className="grid gap-5 border-b border-slate-100 p-6 sm:grid-cols-2">
            <div>
              ...
              <div className="mt-3 flex items-start gap-3">
                <div className="grid size-10 place-items-center rounded-full bg-slate-100 font-black text-slate-700">
                  {initials(
          ...
          <div className="ml-auto max-w-sm space-y-3 p-6">
        ...
        <aside className="space-y-5">
          ...
          <div className="card p-5">
            <h3 className="font-black">PDF invoice</h3>

            <p className="mt-1 text-sm leading-relaxed text-slate-500">
              The PDF is generated directly by your Spring Boot OpenPDF service.
            </p>
